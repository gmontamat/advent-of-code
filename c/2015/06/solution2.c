...
void toggle(int32_t grid[][GRID_WIDTH], int32_t xMin, int32_t yMin, int32_t xMax, int32_t yMax) {
...
void turnOn(int32_t grid[][GRID_WIDTH], int32_t xMin, int32_t yMin, int32_t xMax, int32_t yMax) {
    for (int32_t i=yMin; i<=yMax; ++i) {
        for (int32_t j=xMin; j<=xMax; ++j) {
            grid[i][j]++;
        }
...
void turnOff(int32_t grid[][GRID_WIDTH], int32_t xMin, int32_t yMin, int32_t xMax, int32_t yMax) {
    for (int32_t i=yMin; i<=yMax; ++i) {
        for (int32_t j=xMin; j<=xMax; ++j) {
...
int main(int argc, char **argv) {
    ...
    // Initialize grid
    int32_t grid[GRID_HEIGHT][GRID_WIDTH];
    for (size_t i=0; i < GRID_HEIGHT; ++i) {
        for (size_t j=0; j < GRID_WIDTH; ++j) {
            grid[i][j] = 0;
        }
