...
int32_t run(char program[][BUFFER_SIZE], size_t psize, int32_t initial_a) {
    size_t ctr = 0;
    int32_t a = initial_a, b = 0, c = 0, d = 0;  // registers
    char dstreg, srcreg;
    int32_t val, jmp;
...
int main(int argc, char **argv) {
    ...
    // takes 5 minutes, need to optimize replacing instructions with mult probably
    printf("%d\n", run(program, ctr, 12));
    return 0;
}
